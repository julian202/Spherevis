print("\\Clear");
paint=0;//1 is true and 0 is false (done like this cuz its faster to write 1 than true)
...
showGraph=1; //1 is true and 0 is false (done like this cuz its faster to write 1 than true)
rotateEtc=1;
